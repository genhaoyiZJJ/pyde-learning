...
from utils.torch_utils import initialize_weights, set_trainable
...
class UNetResnet(nn.Module):
    def __init__(self, num_classes, in_channels=3, backbone='resnet50', freeze_backbone=False, pretrained=True):
        super(UNetResnet, self).__init__()
        model = getattr(resnet, backbone)(norm_layer=nn.BatchNorm2d, pretrained=pretrained)
