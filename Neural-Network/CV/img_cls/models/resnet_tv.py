...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv1 = conv3x3(inplanes, planes, stride)  # 卷积层
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv1 = conv1x1(inplanes, planes)  # inplanes:输入通道数  planes：输出通道数
...
if __name__ == "__main__":
    ...
    # forward
    fake_img = torch.randn((64, 3, 224, 224))  # batchsize * channel * height * width
